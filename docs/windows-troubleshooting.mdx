...
sidebar_label: "Windows: Missing vcruntime140.dll"
---


If you are on Windows and `forge` fails to run, you might have an error about a missing `vcruntime140.dll`, or the program might show no output at all. This usually means your system is missing an essential runtime library from Microsoft.
