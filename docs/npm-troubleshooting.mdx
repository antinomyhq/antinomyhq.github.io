...
This guide helps you resolve common Node.js and npm issues. Note: Forge is now installed via `curl -fsSL https://forgecode.dev/install.sh | sh`, but this guide is useful if you need to troubleshoot Node.js or npm for other reasons.
...
### Alternative: Use the curl script

If you continue having PATH issues, you can always reinstall Forge using the curl script:
...
- **[Uninstallation Guide](/docs/uninstallation)** - If you need to completely remove Forge from your system
- **[Installation Guide](/docs/installation)** - Return to the main installation instructions
