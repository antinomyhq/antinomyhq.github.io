...
sidebar_position: 4
description: "Configure Forge to work with your preferred AI provider and customize your experience."
...
<Step number={1} title="Create Environment File" variant="compact">
...
<Step number={2} title="Add Your API Key" variant="compact">

Open the `.env` file in your preferred text editor and add your API key. Here's an example using Open Router (recommended):
