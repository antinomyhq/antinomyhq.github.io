...
description: Configure settings for your Forge instance
---

# Forge Configuration

Forge provides comprehensive configuration options through your `forge.yaml` file. These root-level settings control behavior and apply globally to your entire Forge instance.
