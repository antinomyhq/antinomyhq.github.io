...
title: Installation
sidebar_position: 1
description: "Step-by-step guide to install and configure ZSH support for Forge"
...
If `@filename<Tab>` does nothing, fd and fzf are not installed. See [Step 2](#installation) or our [ZSH Dependencies Installation Guide](/docs/fd-fzf-installation).
...
- Check the [ZSH Dependencies Installation](/docs/fd-fzf-installation) for detailed setup of fd and fzf
