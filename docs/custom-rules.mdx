...
For comprehensive examples, team management strategies, and real-world use cases, check out our [Custom Rules Guide](/guides/custom-rules-guide).
:::
...
| -------------- | ----------------------------- | ------------------------------------------- |
| `custom_rules` | `string`                      | Multi-line text containing rule definitions |
| Global scope   | Root level                    | Rules applied to all agents                 |
| Agent scope    | Under `agents[].custom_rules` | Rules for specific agent                    |

For detailed examples, see the [Custom Rules Guide](/guides/custom-rules-guide).
