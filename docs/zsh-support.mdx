...
<Steps>
  ...
  <Step title="Install zsh-autosuggestions Plugin (Optional)">
    The [zsh-autosuggestions](https://github.com/zsh-users/zsh-autosuggestions) plugin provides fish-like autocomplete suggestions as you type, making it easier to repeat previous Forge commands.
    ...
    **Option 3: Manual Installation**
    ...
    This plugin is optional but highly recommended. It will show suggestions from your command history as you type, making it easier to reuse previous Forge prompts and commands.
    :::
