...
## When to Use ZSH Support vs Interactive Mode

Understanding which mode to use will save you time and frustration:

| Use ZSH Support When | Use Interactive Mode When |
|---------------------|-------------------------|
| You need your shell aliases and custom functions | You're doing focused coding without shell tools |
| Running system commands alongside AI tasks | Working on extended multi-file refactoring |
| Quick one-off questions or small tasks | Deep debugging sessions with lots of context |
| Investigating performance or system issues | You don't need your ZSH customizations |
| Integrating AI into existing shell workflows | Pairing programming with an AI agent |

<div className="rounded-md border border-green-300 bg-green-50 px-4 py-2 mt-3 text-green-900 text-sm">
  <strong>Pro Tip:</strong> You're not locked into one mode. Use ZSH Support for quick requests and shell-heavy workflows, then switch to interactive mode for longer coding sessions. Get the best of both worlds.
</div>
...
<div className="rounded-md border border-blue-300 bg-blue-50 px-4 py-2 mt-3 text-blue-900 text-sm">
  ...
  <ul className="mt-2 mb-0">
    <li><strong>forge</strong> - Main agent for coding, refactoring, debugging, and general development tasks</li>
    <li><strong>muse</strong> - Planning and strategy for complex features</li>
    <li><strong>sage</strong> - Questions and analysis without making code modifications</li>
  </ul>
