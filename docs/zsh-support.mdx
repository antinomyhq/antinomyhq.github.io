...
<div className="rounded-md border border-green-300 bg-green-50 px-4 py-2 mt-3 text-green-900 text-sm">
  <strong>Pro Tip:</strong> You're not locked into one mode. Use ZSH Support for quick requests and shell-heavy
  workflows, then switch to interactive mode for longer coding sessions. Get the best of both worlds.
</div>
