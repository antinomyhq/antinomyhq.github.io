...
Logout from Forge or uninstall Forge Code from your system.

## Logout from Forge

If you want to temporarily stop using Forge without removing the installation, you can simply logout from your current session:

<Steps>
  <Step title="Start Forge and logout">
    ```bash
    # Start forge
    forge

    # Inside the forge session, logout:
    /logout
    ```
...
:::info Quick Return
After logout, you can start using Forge again anytime by running `forge` and completing authentication.
:::
...
<Steps>
  ...
  <Step title="Verify removal">
    ...
    You should see a "command not found" error, confirming successful removal.
  </Step>
</Steps>
