...
Pressing `<Tab>` to open fuzzy selectors requires fd and fzf. See [Installation](/docs/fd-fzf-installation) guide.
:::
...
- [Troubleshooting](/docs/fd-fzf-installation#troubleshooting) - Fix common issues
