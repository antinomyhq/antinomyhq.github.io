...
This will run Forge. When you first run it, Forge will open your browser to [app.forgecode.dev](https://app.forgecode.dev/app) for authorization. Complete the Auth process to authenticate.
