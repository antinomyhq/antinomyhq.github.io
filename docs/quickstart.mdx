...
:::info Essential Keyboard Shortcuts
**Interrupting Operations**

- `CTRL+C`: Stop any running operation (AI requests, network calls, file processing, shell commands)

**Exiting Forge**

- `CTRL+D`: Exit the Forge session completely
  :::
...
### <CodeXml size={20} style={{verticalAlign: 'middle', marginRight: 6}} /> **Refactor code**
