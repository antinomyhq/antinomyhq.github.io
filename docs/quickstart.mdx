...
<NextSteps
  items={[
    {
      logo: <Terminal size={24} style={{color: themeColors.commandsReference}} />,
      title: "Commands Reference",
      subtitle: "Master all commands and options",
      link: "/docs/commands",
    },
    {
      logo: <Zap size={24} style={{color: themeColors.customProviders}} />,
      title: "Custom Providers",
      subtitle: "Configure different AI providers",
      link: "/docs/custom-providers",
    },
    {
      logo: <GitBranch size={24} style={{color: themeColors.advancedConfig}} />,
