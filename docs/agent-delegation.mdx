...
4. **Execution**: The system routes agent tool calls to the appropriate specialist
...
- `description`: Required for tool discovery and validation
...
```json
{
  ...
  "arguments": {
    "tasks": [
      "Specific task description for the agent to perform"
    ]
  }
}
```
