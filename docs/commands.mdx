...
The `/conversations` command displays your last 20 conversations with timestamps and titles, allowing you to interactively select one to resume.
...
The `/provider` command displays an interactive list of your configured AI providers and allows you to switch between them. Only providers with valid API keys will appear in the list.
