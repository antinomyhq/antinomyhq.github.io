...
Add color-coded prompts to make Forge commands visually distinct.

The [zsh-syntax-highlighting](https://github.com/zsh-users/zsh-syntax-highlighting) plugin provides syntax highlighting for Forge prompts.
...
### Fuzzy File Finding (Recommended)
