...
This guide provides platform-specific installation instructions for the dependencies required by [ZSH Quickstart](/docs/zsh-quickstart/):
...
4. **Check the [ZSH Quickstart troubleshooting section](/docs/zsh-quickstart/#troubleshooting)** for additional help.
...
- [ZSH Quickstart Documentation](/docs/zsh-quickstart)
