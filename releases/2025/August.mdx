...
- fix: ensure tool_choice is set only when tools are defined in the req [@amitksingh1490](https://github.com/amitksingh1490) ([#1414](https://github.com/antinomyhq/forge/pull/1414))
...
- Revert "fix: ensure tool_choice is set only when tools are defined in… [@amitksingh1490](https://github.com/amitksingh1490) ([#1413](https://github.com/antinomyhq/forge/pull/1413))
...
- fix: compaction token_count logic [@jayantpranjal0](https://github.com/jayantpranjal0) ([#1343](https://github.com/antinomyhq/forge/pull/1343))
