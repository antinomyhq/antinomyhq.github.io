    ...
    return (
      ...
      >
        {Object.values(resultsCategory).map((category) => {
          return (
            <div
              className={`flex justify-between items-center p-1 pl-3 gap-2 sm:gap-0 sm:px-3 sm:py-2 sm:w-[180px] ${selectedCategory === category ? "border border-solid border-tailCall-border-dark-500 sm:bg-tailCall-black sm:border-none sm:text-white" : ""}`}
            ...
            >
              ...
              <span
                className={`flex justify-center items-center py-[2px] px-[6px] md:py-0 !font-medium text-content-tiny sm:text-content-small ${selectedCategory === category ? "text-white bg-tailCall-black sm:bg-transparent" : "text-tailCall-dark-100 bg-tailCall-light-200"}`}
              >
