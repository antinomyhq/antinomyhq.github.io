  ...
  return (
    <div className="flex justify-center">
      <button
        ...
        className="mt-4 h-12 cursor-pointer border-2 border-solid border-tailCall-border-dark-100 bg-transparent px-4 py-2 text-title-tiny font-bold text-black"
      >
        Load more blogs
      </button>
    </div>
